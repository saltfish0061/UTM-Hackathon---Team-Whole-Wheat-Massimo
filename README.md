...
[Video Presentation Link](https://youtu.be/MPfpD1F3Rtk)
...
### 🏗️ Hardware and Smart Sensing
*   **Arduino-Based System:** The physical prototype is developed using **Arduino** combined with a **Bluetooth module** for seamless pairing with mobile devices.
*   **Optimized Sensor Placement:** 
    *   Soil sensors are implanted directly into the soil for subterranean monitoring.
    *   The **LED receiver** is strategically placed on the side to ensure direct exposure to LED light.
*   **Mobile Connectivity:** Every sensor is linked to the Arduino + Bluetooth module to transmit live data directly to the mobile application software.
...
© 2026 Team Whole Wheat Massimo - UTM Hackathon
